  ...
  return (
    <div>
      ...
      <div className="mt-[1rem] sm:mt-auto sm:p-auto  box-border text-center flex relative flex-col justify-center items-center overflow-hidden">
        ...
        {/* fixed bugs : added text-color and width*/}
        <p className="text-[#4b4b4b] w-[360px] sm:w-auto px-[1.5rem] sm:px-auto text-[18px] font-[400] leading-[130%] font-poppins-regular-20 m-0 mt-[1.5rem] mb-8 text-center">
