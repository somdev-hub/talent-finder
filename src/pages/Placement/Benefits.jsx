    ...
    <div className="p-[1.5rem] md:p-[3rem] lg:p-[5rem] mt-[2rem] sm:mt-auto flex flex-col items-center justify-center ">
      ...
      <div className="flex xl:flex-row flex-col sm:gap-8 mt-10 sm:mt-[6rem] items-center justify-center">
        ...
        <div className="grid lg:justify-items-center xl:justify-items-start">
          ...
          <div className=" lg:w-[70%] xl:w-[80%] flex-col sm:grid grid-cols-2 grid-rows-2 sm:gap-10 xl:gap-0 mt-5 sm:text-left text-center">
            {benefits.map((benefit, index) => {
              return (
                <div key={index} className="font-poppins-regular-20 mb-6">
                  ...
                  <p className="w-[338px] xl:w-[240px] sm:pr-[25%] font-[400] leading-[120%] sm:text-[1rem] text-[14px] text-text-medium">
                    {benefit.desc}
                  </p>
                </div>
              );
            ...
            {benefits_sm.map((benefit, index) => {
              return (
                <div key={index} className="font-poppins-regular-20 mb-6">
                  ...
                  <p className="w-[338px] sm:pr-[25%] font-[400] leading-[120%] sm:text-[1rem] text-[14px] text-text-medium">
                    {benefit.desc}
                  </p>
                </div>
              );
